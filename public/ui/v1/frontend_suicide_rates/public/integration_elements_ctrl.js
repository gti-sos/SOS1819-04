...
angular
    ...
    .controller("IntegrationElementsCtrl",["$scope","$http", "$location", function ($scope,$http,$location){
                ...
                console.log("[Elements Integration] INTEGRATION Biofuel Productions Main Controller initialized.");
                
                var URL = "/api/v1/suicide-rates/proxy-elements";
                var URL_BASE = "/api/v1/suicide-rates/proxy-elements";
